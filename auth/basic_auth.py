...
def get_current_username(
        ...
        db : Session = Depends(get_db)              # httpbasiccrenentials   خوب این میاد اون پسوورد و یوزرنیم رو در این نگه میداره و باید اینو بزاریم جز حفظی ها هستش 
):                                                  # مثل یک دیکشنری این مثلا کار میکنه فهمیدی  HTTPBasicCredentials
...
# ببین مفهموم این هست که خوب بیاد اول با یوزرنیم و پسوورد لاگین کنه و بعذش بیاذ خوب 
# وقتی دید اینا از دیتابیس درسته خوب دیکه بهش یک به این کاربر یک چیزی میده بنام 
# jwt
# این برای این است این کاربر از این بع بعد دیکه با این فقط میاد و میره همین به جای اینکه 
# دیکه رمز و اینا بزنه همین 
